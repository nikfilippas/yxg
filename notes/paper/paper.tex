...
\section*{Acknowledgements}
  ...
  In data analysis the {\tt python} packages {\tt numpy}, {\tt scipy} were used. For our plots, we used {\tt matplotlib}. 
