...
\title[Tomographic measurement of the intergalactic gas pressure through galaxy-tSZ cross-correlations]{Wide-angle tomographic measurement of the intergalactic gas pressure through galaxy-tSZ Fcross-correlations}
...
\section{Theory}\label{sec:theory}
  ...
  \subsection{Halo model predictions}\label{ssec:theory.hm}
    ...
    \subsubsection{Galaxies and the halo occupation distribution}\label{sssec:theory.hm.hod}
      ...
      Coupling $M_0$ and $M_{\rm min}$ allows for all haloes containing a central to also contain satellites, and conversely, for all haloes containing satellites to necessarily contain a central. This assumption breaks down in cases such as mergers, where centrals have not been established yet. Nevertheless, we have confirmed that decoupling $M_0$ and $M_{\rm min}$, and allowing haloes to contain solely satellites, does not yield any statistically significant offset from our fiducial scenario. We have also tested the effect of freeing-up $\sigma_{\rm lnM}$, and confirmed that the measurements we obtain are almost identical to our fiducial results.
