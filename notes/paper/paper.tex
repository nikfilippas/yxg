...
\section{Theory}\label{sec:theory}
  ...
  \subsection{Halo model predictions}\label{ssec:theory.hm}
    ...
    \end{align}
    Here, $P_L(k)$ is the linear matter power spectrum, $dn/dM$ is the halo mass function and $b_h(M)$ is the halo bias \cites. %Further details are discussed in Appendix \ref{app:hm}.
