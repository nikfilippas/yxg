...
\section{Conclusion}\label{sec:conclusion}
  \begin{itemize}
    \item Tomographic measurement of $1-b_H$. Agreement with value measured by Planck clusters and CMB lensing mass calibration. No evidence for redshift dependence.
    \item Tomographic measurement of $\langle bP_e\rangle$. In good agreement with previous results and theoretical expectations. Best constraints to date.
    \item Robustness to a bunch of systematics (CIB, clustering contamination, photo-$z$). Blab a bit about degeneracies between different HOD parameters and photo-$z$ uncertainties.
  \end{itemize}
