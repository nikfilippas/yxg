...
def halo_trispectrum(cosmo,k,a,profiles,logMrange=(6,17),mpoints=128,**kwargs):
...
def ang_1halo_covariance(cosmo, fsky, l, profiles_a, profiles_b,
    ...
    k=(l+1/2)/chi[...,None]
    t1h=halo_trispectrum(cosmo,k,a,(pau,pav,pbu,pbv),logMrange,mpoints,**kwargs)
